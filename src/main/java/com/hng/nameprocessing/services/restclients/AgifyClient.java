...
public class AgifyClient {
    ...
    Logger LOGGER = LoggerFactory.getLogger(AgifyClient.class);


    public AgifyClient(RestClient.Builder restClientBuilder, @Qualifier("asyncExecutor") Executor executor ) {
    ...
    @SneakyThrows
    public CompletableFuture<AgifyResponse> agifyRequest(String name){
        ...
        return CompletableFuture.supplyAsync(() -> restClient.get()
            ...
            .body(AgifyResponse.class), executor);
    }
