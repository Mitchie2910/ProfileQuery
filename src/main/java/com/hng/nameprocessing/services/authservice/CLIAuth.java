...
public class CLIAuth {
    ...
    public CLIAuth(UserService userService, JwtService jwtService, GitHubClient gitHubClient, @Qualifier("asyncExecutor") Executor executor) {
    ...
    public CompletableFuture<AuthResponse> authenticate(String code, String codeVerifier){
        return gitHubClient.exchangeCode(code, codeVerifier)
                .thenCompose(gitHubClient::fetchUser)
                .thenApply(gitHubUser -> {
