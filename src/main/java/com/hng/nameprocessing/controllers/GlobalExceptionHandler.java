...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected @Nullable ResponseEntity<Object> handleHttpMessageNotReadable(
    ...
    ErrorDto errorDto = ErrorDto.builder().message("Request submitted without content").build();
  ...
  protected @Nullable ResponseEntity<Object> handleTypeMismatch(
    ...
    ErrorDto errorDto = ErrorDto.builder().message("Input name cannot be processed").build();
  ...
  protected @Nullable ResponseEntity<Object> handleMissingServletRequestParameter(
    ...
    ErrorDto errorDto = ErrorDto.builder().message("Input parameter is missing").build();
    return ResponseEntity.status(400).body(errorDto);
  }
