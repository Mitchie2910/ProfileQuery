...
public class JwtService {
    ...
    public JwtService(RefreshTokenRepository refreshTokenRepository, UserService userService) throws Exception{
    ...
    public String generateRefreshToken(final AuthContext ctx) {
        ...
        RefreshTokenMapping refreshTokenMapping = RefreshTokenMapping.builder()
                .tokenId(jti)
                .revoked(false)
    ...
    private String buildToken(final String githubId, final Map<String, Object> claims, final long tokenExpiration) {
        Algorithm algorithm = Algorithm.RSA256(null, privateKey);
        return JWT.create()
                .withClaim("roles", (List<String>)claims.get("role"))
                .withClaim(TOKEN_TYPE,(String) claims.get(TOKEN_TYPE))
